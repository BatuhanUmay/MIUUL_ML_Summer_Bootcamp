...
agg_df["customers_level_based"] = [val[0].upper() + "_" + \
                                   val[1].upper() + "_" + \
                                   val[2].upper() + "_" + \
                                   str(val[-1]) for val in agg_df.values]
agg_df.sort_values("PRICE", ascending=False)[["customers_level_based", "PRICE"]]
customers_level_based = agg_df.groupby("customers_level_based").agg({"PRICE": "mean"}).sort_values("PRICE",
                                                                                                   ascending=False)
#############################################
